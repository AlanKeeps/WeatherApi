приложение для отображение погоды по часам и прогноз на 3 дня и по часам. Получаю информацию из публичного апи, отрисовка элементов через ресайклервью./n
